...
<div id="page-wrapper">
  ...
  <div class="container-fluid">
    ...
    <?php
      ...
      <form class="form-horizontal" action="<?= base_url() ?>szkolenia/edytuj/" method="post">

         <input type="hidden" name="id_szkolenia" id="id_szkolenia" value=<?php echo $row->id ?>>
        
        <div class="form-group">
          <label for="inputEmail3" class="col-sm-2 control-label">Nazwa </label>
          <div class="col-sm-4">
            <input type="text" class="form-control" id="nazwa" name="nazwa" placeholder="Nazwa" value=<?php echo $row->nazwa ?>>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <input type="text" class="form-control" id="data" name="data" placeholder="Data" value=<?php echo $row->data ?>>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            <input type="text" class="form-control" id="miejsce" name="miejsce" placeholder="Miejsce" value=<?php echo $row->miejsce ?>>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <textarea class="form-control" rows="4" id="info" name="info"><?php echo $row->info ?></textarea>
          </div>
        </div>
...
<?php foreach ($uczesnicy as $ro)  { $tab[] = $ro->id; } ?>
